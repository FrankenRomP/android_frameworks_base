...
import com.android.internal.util.franken.DeviceUtils;
...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    protected void makeStatusBarView() {
        ...
        filter.addAction(FrankenUtils.ACTION_DISMISS_KEYGUARD);
    ...
    public boolean isUsingDarkTheme() {
        ...
        try {
            themeInfo = mOverlayManager.getOverlayInfo("com.android.system.theme.dark.franken",
    ...
    public boolean isUsingBlackTheme() {
        OverlayInfo themeInfo = null;
        try {
            themeInfo = mOverlayManager.getOverlayInfo("com.android.system.theme.black.franken",
                    mLockscreenUserManager.getCurrentUserId());
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            else if (FrankenUtils.ACTION_DISMISS_KEYGUARD.equals(action)) {
                if (intent.hasExtra(FrankenUtils.DISMISS_KEYGUARD_EXTRA_INTENT)) {
                    Intent launchIntent = (Intent) intent.getParcelableExtra(FrankenUtils.DISMISS_KEYGUARD_EXTRA_INTENT);
    ...
    protected void updateTheme() {
        ...
        if (isUsingDarkTheme() != useDarkTheme) {
                try {
                    mOverlayManager.setEnabled("com.android.system.theme.dark.franken",
                            useDarkTheme, mLockscreenUserManager.getCurrentUserId());
                    mOverlayManager.setEnabled("com.android.systemui.theme.dark.franken",
                            useDarkTheme, mLockscreenUserManager.getCurrentUserId());
                    mOverlayManager.setEnabled("com.android.settings.theme.dark.franken",
                            useDarkTheme, mLockscreenUserManager.getCurrentUserId());
                    // Check for black and white accent so we don't end up
                    // with white on white or black on black
                    unfuckBlackWhiteAccent();
        ...
        if (isUsingBlackTheme() != useBlackTheme) {
                try {
                    mOverlayManager.setEnabled("com.android.system.theme.black.franken",
                            useBlackTheme, mLockscreenUserManager.getCurrentUserId());
                    mOverlayManager.setEnabled("com.android.systemui.theme.black.franken",
                            useBlackTheme, mLockscreenUserManager.getCurrentUserId());
                    mOverlayManager.setEnabled("com.android.settings.theme.black.franken",
                            useBlackTheme, mLockscreenUserManager.getCurrentUserId());
                    // Check for black and white accent so we don't end up
                    // with white on white or black on black
                    unfuckBlackWhiteAccent();
